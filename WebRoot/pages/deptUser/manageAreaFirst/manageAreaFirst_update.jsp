...
<body>
    ...
    <form method="post" id="fm">
	    <ul class="forminfo">
	        <li>
		    	<label>一级管辖域编号：</label>
			    <input name="afId" id="afId" value="${manageAreaFirst.afId}" type="text" required readonly class="dfinput"/>
			    <i><font color="#FF0000">*必填</font>
		    </li>
		    <li>
		    	<label>名称：</label>
			    <input name="afName" id="afName" value="${manageAreaFirst.afName}" type="text" required class="dfinput"/>
			    <i><font color="#FF0000">*必填</font><font id="afName1">2-5个字符组成</font></i>
		    </li>
		    <li>
		    	<label>单位编号：</label>
			    <input name="dept.deptId" id="deptId" value="${manageAreaFirst.dept.deptId}" type="text" required readonly class="dfinput" />
			    <i><font color="#FF0000">*必填</font>
		    </li>
		    <li>
		    	<label>一级管辖员：</label>
			    <select name="ufId" class="dfinput">
			       <option value="${manageAreaFirst.ufId}" selected="">${manageAreaFirst.ufId}</option>
...
<script>
	...
	$("#btn").click(function(e){
		...
		$.post("<%=basePath%>/sys/manageAreaFirst_update.action", params, function(data){
			if(data.targ == true){
