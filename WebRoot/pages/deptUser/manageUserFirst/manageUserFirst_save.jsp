...
<body>
    ...
    <form method="post" id="fm">
	    <ul class="forminfo">
		    <li>
		    	<label>姓名：</label>
			    <input name="ufName" id="ufName" type="text" required class="dfinput"/>
		    ...
		    <li>
		    	<label>电话：</label>
			    <input name="ufPhone" id="ufPhone" type="text" required class="dfinput" />
			    <i><font color="#FF0000">*必填</font><forn id="ufPhone1">11位数字组成</forn></i>
		    </li>
		    <li>
		    	<label>用户类型：</label>
		    ...
		    <li>
		    	<label>单位管理员工号：</label>
			    <input name="deptUser.userId" id="userId" value="${userCode}" type="text" required readonly class="dfinput" />
...
<script>
	...
	$("#btn").click(function(e){
		...
		$.post("<%=basePath%>/sys/manageUserFirst_save.action", params, function(data){
			if(data.targ == true){
