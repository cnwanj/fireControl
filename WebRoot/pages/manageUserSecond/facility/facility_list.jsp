...
<script type="text/javascript">
	...
	$(".sure").click(function(){
		...
		$.post("<%= basePath%>/sys/facility_delete.action", {facId:id}, function(data){
			var url = "<%=basePath%>/sys/Facility_findByPage.action";
			if(data.targ == true){
...
<div class="formbody">
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
     	...
     	<form action="<%= basePath%>/sys/Facility_findByPage.action" method="post" target="rightFrame">
    	<ul class="seachform">
    	    <li><label>搜索</label><input class="scinput" name="facName" placeholder="请输入名称"/></li>
            <li><input name="" type="submit" class="scbtn" value="搜索"/></li>
            	<li class="clickk"><a href="<%= basePath%>/sys/Facility_openSave.action"><span><img src="<%=path%>/images/t01.png" /></span> 添加</a></li>
            <li>
        ...
        <tbody>
	        ...
	        <tr>
		        ...
		        <td>&nbsp;
	        		...
	        		<a href="<%=basePath%>/sys/Facility_openUpdate.action?facId=${facId}" class="tablelink">修改</a>
		        </td>
	        </tr> 
	        </s:iterator>
        </tbody>
...
<%
//查询的url地址，统一写
String listActionURL = basePath+"/sys/Facility_findByPage.action";
%>
