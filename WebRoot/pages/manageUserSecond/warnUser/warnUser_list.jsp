...
<script type="text/javascript">
	...
	$(".sure").click(function(){
		$(".tip").fadeOut(100);
		$.post("<%= basePath%>/sys/warnUser_delete.action", {userId:id}, function(data){
			var url = "<%=basePath%>/sys/WarnUser_findByPage.action";
			if(data.targ == true){
...
<div class="formbody">
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
     	...
     	<form action="<%= basePath%>/sys/WarnUser_findByPage.action" method="post" target="rightFrame">
    	<ul class="seachform">
    	    <li><label>搜索</label><input class="scinput" name="userName" placeholder="请输入名字"/></li>
            <li><input name="" type="submit" class="scbtn" value="搜索"/></li>
            	<li class="clickk"><a href="<%= basePath%>/sys/WarnUser_openSave.action"><span><img src="<%=path%>/images/t01.png" /></span> 添加</a></li>
            <li>
        ...
        <tbody>
	        ...
	        <tr>
		        ...
		        <td>&nbsp;
	        		...
	        		<a href="<%=basePath%>/sys/WarnUser_openUpdate.action?userId=${userId}" class="tablelink">修改</a>
		        </td>
	        </tr> 
	        </s:iterator>
        </tbody>
...
<%
//查询的url地址，统一写
String listActionURL = basePath+"/sys/WarnUser_findByPage.action";
%>
...
<script type="text/javascript">
var url = "<%=basePath%>/sys/WarnUser_findByPage.action";                 //获取表单url
//首页
function first(){
