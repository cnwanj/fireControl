...
<script type="text/javascript">
	...
	$(".sure").click(function(){
		...
		$.post("<%= basePath%>/sys/installPoint_delete.action", {insId:id}, function(data){
			var url = "<%=basePath%>/sys/InstallPoint_findByPage2.action?asId=${asId}";
			if(data.targ == true){
...
<div class="formbody">
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
     	...
     	<form action="<%= basePath%>/sys/InstallPoint_findByPage2.action?asId=${asId}" method="post" target="rightFrame">
    	<ul class="seachform">
        ...
        <tbody>
	        ...
	        <tr>
		        ...
		        <td>&nbsp;
		        	...
		        	<a href="<%= basePath%>/sys/Facility_findByPage2.action?insId=${insId}" class="tablelink">设备信息管理</a>
		        </td>
	        </tr> 
	        </s:iterator>
        </tbody>
...
<%
//查询的url地址，统一写
String listActionURL = basePath+"/sys/InstallPoint_findByPage2.action?asId=${asId}";
%>
...
<script type="text/javascript">
var url = "<%=basePath%>/sys/InstallPoint_findByPage2.action?asId=${asId}";                 //获取表单url
//首页
function first(){
