...
<script type="text/javascript">
	...
	$(".sure").click(function(){
		...
		$.post("<%= basePath%>/sys/facility_delete.action", {facId:id}, function(data){
			var url = "<%=basePath%>/sys/Facility_findByPage2.action?insId=${insId}";
			if(data.targ == true){
...
<div class="formbody">
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
     	...
     	<form action="<%= basePath%>/sys/Facility_findByPage2.action?insId=${insId}" method="post" target="rightFrame">
    	<ul class="seachform">
...
<%
//查询的url地址，统一写
String listActionURL = basePath+"/sys/Facility_findByPage2.action?insId=${insId}";
%>
...
<script type="text/javascript">
var url = "<%=basePath%>/sys/InstallPoint_findByPage2.action?insId=${insId}";                 //获取表单url
//首页
function first(){
