...
<body>
    ...
    <div class="formbody">
    <div class="formtitle"><span>单位管理员基本信息</span></div>
...
<script>
	...
	$("#btn").click(function(e){
		...
		$.post("<%=basePath%>/sys/deptUser_save.action", params, function(data){
			if(data.targ == true){
				window.location.href = '<%=basePath%>/sys/DeptUser_findByPage.action?t=save';
			}else{
				$("#loginName").css("color", "red").text("该用户名已存在！").css("font-size", "15px");
			}
		});
	});
</script>
