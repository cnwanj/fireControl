...
<script type="text/javascript">
	...
	$(".sure").click(function(){
		$(".tip").fadeOut(100);
		$.post("<%= basePath%>/sys/deptUser_delete.action", {userId:id}, function(data){
			var url = "<%=basePath%>/sys/DeptUser_findByPage.action";
			if(data.targ == true){
...
<div class="formbody">
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
    	...
    	<ul class="seachform">
    	    <li><label>搜索</label><input class="scinput" name="deptName" placeholder="请输入姓名"/></li>
            <li><input name="" type="submit" class="scbtn" value="搜索"/></li>
            	<li class="clickk">
            		<%-- <a href="<%= basePath%>/pages/sysUser/deptUser/deptUser_save.jsp"> --%>
            		<a href="<%= basePath%>/sys/DeptUser_findByDept.action">
            		<span><img src="<%=path%>/images/t01.png" /></span> 添加</a>
            	</li>
            <li>
        ...
        <tbody>
	        ...
	        <tr>
		        ...
		        <td>&nbsp;
	        		...
	        		<a href="<%=basePath%>/sys/DeptUser_getOne.action?userId=${userId}" class="tablelink">修改</a>
		        </td>
	        </tr> 
	        </s:iterator>
        </tbody>
