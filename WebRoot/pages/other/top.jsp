...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <div class="topleft">
    	<a href="main.jsp" target="_parent"><h2 style="color:white; padding:20px 0 0 5px; font-size:28px">消防智能设备管理系统</h2><!-- <img src="images/logo.png" title="系统首页" /> --></a>
    </div>
    ...
    <li><a href="#">关于</a></li> -->
    <li><a href="${path}/sys/SysUser_openIndex.action" target="rightFrame">回到首页</a></li>
